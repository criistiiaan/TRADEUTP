...
class _DetailsItemPageState extends State<DetailsItemPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Color.fromARGB(255, 248, 255, 245), // Cambiar el color de fondo del cuerpo
      appBar: PreferredSize(
        preferredSize: Size.fromHeight(100.0), // Altura personalizada del AppBar
        child: Container(
          decoration: BoxDecoration(
            color: Color.fromARGB(255, 248, 255, 245), // Cambiar el color de fondo del AppBar

          ),
          child: AppBar(
            centerTitle: true,
            toolbarHeight: 100,
            backgroundColor: Colors.transparent, // Hacer transparente para aplicar el color del contenedor
            elevation: 0, // Quitar la sombra predeterminada del AppBar
            leading: IconButton(
              onPressed: () {
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: item['image'].isNotEmpty
                          ? Image.file(
                              File(item['image']),
                              width: MediaQuery.of(context).size.width * 0.8, // 80% of screen width
                              height: MediaQuery.of(context).size.width * 0.6, // Aspect ratio to keep the image balanced
                              fit: BoxFit.cover,
                            )
                          : Placeholder(
                              fallbackWidth: MediaQuery.of(context).size.width * 0.8,
                              fallbackHeight: MediaQuery.of(context).size.width * 0.6,
                  ...
                  Text(
                    ...
                    style: TextStyle(color: colormainColor, fontWeight: FontWeight.bold, fontSize: 16),
                  ),
                  Container(
                    child: Row(
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ConversationPage(id: item['fromUsers'], name: name_seller),
                              ),
                            );
                          },
                          child: Column(
                  ...
                  Text(
                    "El usuario no tiene más publicaciones",
                    style: TextStyle(color: colorfaintColor, fontSize: 12),
                  ),
                ],
              ),
            );
